...
// binary: the Result/Hash types the subprocess contract's Result JSON
// mirrors, (*Result).Print to emit it correctly, and (in log.go) OpenLog
// for the plugin's own --log file. See plugins/CONTRACT.md for the full
// contract this package implements one side of; unlike that document,
